...
<div class="min-h-screen flex justify-center items-center">
    ...
    <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
        ...
        <div>
            <h1 class="text-3xl font-bold text-center mb-4 cursor-pointer"> Bienvenu Patient</h1>
        ...
        <form:form action="login" method="post" modelAttribute="patient">

            <div class="space-y-4">
                <form:input type="text" placeholder="Matricule" path="matricule"
